                ...
                <Card className="overflow-hidden">
                  <div className="relative">
                    ...
                    {job.header_image_url ? (
                      ...
                      <>
                        {/* Default Background */}
                        <div className="w-full h-64 sm:h-80 lg:h-96 relative bg-gradient-to-br from-black/50 to-black-900/90"> 
                          <div className="absolute inset-0 bg-[url('https://i.imgur.com/7fxaf8v.jpeg')] bg-cover bg-center mix-blend-overlay opacity-50"></div>
