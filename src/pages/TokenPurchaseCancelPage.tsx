              ...
              <Card className="text-center">
                <CardHeader className="pb-4">
                  ...
                  <p className="text-gray-600 dark:text-gray-400">
                    Your token purchase was cancelled. No charges have been made to your account.
                  </p>
                </CardHeader>
                ...
                <CardContent className="space-y-6">
                  <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400">
                      You cancelled the token purchase process before completing your payment. 
                      No tokens were added to your account and no payment was processed.
                    </p>
                  </div>
                  ...
                  <div className="text-xs text-gray-500 dark:text-gray-400 pt-4 border-t border-gray-200 dark:border-gray-700">
                    <p>
                      If you experienced any issues during the purchase process, please contact our support team 
                      and we'll be happy to help you get the tokens you need.
                    </p>
                  </div>
                </CardContent>
              </Card>
...
export default TokenPurchaseCancelPage;